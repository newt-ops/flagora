export function PlaySkeleton() {
  return (
    <div className="flex w-full max-w-md mx-auto flex-col gap-4 text-tg-text animate-pulse">
      <div className="flex items-center justify-between rounded-2xl bg-tg-section p-4 shadow-sm">
      ...
      <div className="flex flex-col gap-3">
        <div className="h-20 w-full rounded-2xl bg-tg-section p-4" />
        <div className="h-20 w-full rounded-2xl bg-tg-section p-4" />
        <div className="h-20 w-full rounded-2xl bg-tg-section p-4" />
      </div>
    </div>
...
export function LeaderboardSkeleton() {
  return (
    <div className="flex w-full max-w-md mx-auto flex-col gap-4 text-tg-text animate-pulse">
      <div className="flex items-center justify-between">
        <div className="h-10 w-10 rounded-xl bg-tg-section" />
        <div className="h-6 w-36 rounded-md bg-tg-section" />
        <div className="h-10 w-10" />
      </div>

      <div className="h-11 w-full rounded-xl bg-tg-secondary-bg" />
...
export function ProfileSkeleton() {
  return (
    <div className="flex w-full max-w-md mx-auto flex-col items-center gap-4 text-tg-text animate-pulse">
      <div className="w-full rounded-2xl bg-tg-section p-6 shadow-sm">
        ...
        <div className="mt-5 h-16 w-full rounded-xl bg-tg-secondary-bg" />

        <div className="mt-3 grid grid-cols-2 gap-3">
          <div className="h-20 rounded-xl bg-tg-secondary-bg" />
          <div className="h-20 rounded-xl bg-tg-secondary-bg" />
          <div className="h-20 rounded-xl bg-tg-secondary-bg" />
          <div className="h-20 rounded-xl bg-tg-secondary-bg" />
        </div>
    ...
    <div className="flex w-full max-w-md mx-auto flex-col items-center gap-4 text-tg-text animate-pulse">
      <div className="flex w-full flex-col items-center rounded-2xl bg-tg-section p-6 text-center shadow-sm">
        ...
        <div className="mt-6 grid w-full grid-cols-2 gap-3">
          <div className="h-32 rounded-xl bg-tg-secondary-bg" />
          <div className="h-32 rounded-xl bg-tg-secondary-bg" />
        </div>
